  ...
  window.Chart=function(domId){
    ...
    $this.ratePieNoAnimation=function(number){
        ...
        var grd = ctx.createLinearGradient(0,H, W, 0);//颜色渐变的起始坐标和终点坐标
            grd.addColorStop(0, "#82b8e2");
            grd.addColorStop(0.3, "#82b8e2");
            grd.addColorStop(0.6, "#82b8e2");
            grd.addColorStop(1, "#82b8e2");
        ...
        var grd = ctx.createLinearGradient(W, 0, 0,H);
           grd.addColorStop(0, "#b0d0ea");
            grd.addColorStop(0.3, "#b0d0ea");
            grd.addColorStop(0.6, "#b0d0ea");
            grd.addColorStop(1, "#b0d0ea");
            ctx.strokeStyle = grd;
        //ctx.lineWidth=inW;
        ...
        var grd = ctx.createLinearGradient(0,H, W, 0);
            grd.addColorStop(0, "#137ed0");
            grd.addColorStop(0.3, "#137ed0");
            grd.addColorStop(0.6, "#137ed0");
            grd.addColorStop(1, "#137ed0");
            ctx.strokeStyle = grd;
        ctx.lineWidth=outW;
