...
public class XListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setText(R.string.xlistview_footer_hint_load_more);
		} else if(state == STATE_NORMAL){// load end 
			mProgressBar.setVisibility(View.GONE);
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.xlistview_footer_hint_load_end);
		}else if(state == STATE_NO_DATA){
			mProgressBar.setVisibility(View.GONE);
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(R.string.xlistview_footer_hint_no_data);
		}
	}
